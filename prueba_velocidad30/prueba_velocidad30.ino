...
void loop(){
  ...
  cny();
 if(compara(recto)){
   Velocidad(ADELANTE,30,30);
   delay(2);
 }
 else if(compara(izquierda)){
   Velocidad(ADELANTE,20,30);
   delay(2);
 }
 else if(compara(derecha)){
   Velocidad(ADELANTE,30,20);
   delay(2);
 }
   ...
   Velocidad(ADELANTE,15,35);
   delay(2);
 }
 if(compara(extremo_derecha)){
   Velocidad(ADELANTE,35,15);
   delay(2);
 }
